...
class HaveCakeProblem(Problem):
    ...
    def __init__(self, initial: FluentState, goal: list):
        # list of positive and negative fluents
        self.state_map = initial.pos + initial.neg
        Problem.__init__(self,
                         # "TFFTFT" string of mapped positive and negative fluents
                         encode_state(initial, self.state_map),
                         goal=goal)
        # list of all actions allowed in the problem
    ...
    def actions(self, state: str) -> list:  # of Actions possible in the given state
        possible_actions = []
        kb = PropKB()
